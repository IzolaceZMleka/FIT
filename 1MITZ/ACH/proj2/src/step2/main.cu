...
int main(int argc, char **argv)
{
    ...
    {
    	//printf("%d tady jsem se dostal!\n",s);
        //shared memory size pro blok odpovídá počtu vláken, aby nedošlo k požadavku na větší počet bytu než dovoluje architektura
        calculate_velocity<<<grid, thr_blc, thr_blc * 2 * sizeof(float4)>>>(particles_gpu1, particles_gpu2, N, dt);
